...
[gitian.sigs](https://github.com/OasisCoinTeam-project/gitian.sigs/) repository:
...
You can also mail the files to Fuzzbawls (fuzzbawls@oasisco.in) and he will commit them.
