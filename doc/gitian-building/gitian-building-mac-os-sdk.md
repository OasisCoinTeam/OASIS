...
The script [extract-osx-sdk.sh](https://github.com/OasisCoinTeam/oasis/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
oasis/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/OasisCoinTeam/oasis/blob/master/doc/README_osx.md) for troubleshooting tips.