...
The build script we'll be using is contained in the OASIS github repository ([contrib/gitian-build.py](https://github.com/OasisCoinTeam/oasis/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the OASIS repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/OasisCoinTeam/oasis/master/contrib/gitian-build.py
