...
#include "qt/oasis/settings/settingsnetworkwidget.h"
#include "qt/oasis/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/oasis/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(OASISGUI* _window, QWidget *parent) :
